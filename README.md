...
- **[Maximizing Sales with Customer Segmentation using EDA, RFM, and Case Study Analysis](https://github.com/jahnvisikligar/Data-Science_projects/tree/main/Maximizing%20Sales%20with%20Customer%20Segmentation%20using%20EDA%2C%20RFM%2C%20and%20Case%20Study%20Analysis)**: In this project, sales data analysis was conducted to understand the target market. The project encompassed Exploratory Data Analysis (EDA), Sales per country, a Case study on the UK using the Apriori algorithm, and Customer Segmentation using RFM.
...
- **[ATM Cash Forecasting](https://github.com/jahnvisikligar/Machine-Learning-and-Data-Science/tree/main/ATM%20Cash%20Forecasting)**: This project applies machine learning and time series feature engineering to forecast daily ATM cash demand using historical transaction data. The solution aims to optimize cash replenishment strategies, minimize idle cash, and prevent cash-out events.
